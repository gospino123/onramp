// Hard-coded data to be used to populate results
...
// Export 4 functions at bottom to use in workAround.js
export {getRoles, getCompanies, getDataByRole, getDataByCompany};
  
// Export salaryData using default keyword to use in workAround.js
